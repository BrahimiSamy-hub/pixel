...
export const alt = 'Photographe Mariage Algérie — Shooting & Vidéo — Pixel Creative Agency'
    ...
    (
      ...
      >
        ...
        <div style={{ color: 'white', fontSize: '58px', fontWeight: '900', lineHeight: '1.1', maxWidth: '820px' }}>
          Photographe Mariage — Shooting & Vidéo
        </div>
        <div style={{ color: 'rgba(255,255,255,0.45)', fontSize: '22px', marginTop: '28px' }}>
          Reportage complet · Cinémato · Album souvenir · Forfaits Algérie
        </div>
