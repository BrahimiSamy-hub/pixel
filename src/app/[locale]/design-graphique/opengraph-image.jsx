...
export const alt = 'Design Graphique, Logo & Identité Visuelle — Pixel Creative Agency Algérie'
    ...
    (
      ...
      >
        ...
        <div style={{ color: 'white', fontSize: '58px', fontWeight: '900', lineHeight: '1.1', maxWidth: '820px' }}>
          Design Graphique, Logo & Identité Visuelle
        </div>
        <div style={{ color: 'rgba(255,255,255,0.45)', fontSize: '22px', marginTop: '28px' }}>
          Logo · Charte graphique · Cadres · Packaging · Carte de visite
        </div>
