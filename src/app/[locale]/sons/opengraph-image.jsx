...
export const alt = 'Production Audio & Jingle Publicitaire — Pixel Creative Agency Algérie'
    ...
    (
      ...
      >
        ...
        <div style={{ color: 'white', fontSize: '58px', fontWeight: '900', lineHeight: '1.1', maxWidth: '820px' }}>
          Production Audio & Jingles Publicitaires
        </div>
        <div style={{ color: 'rgba(255,255,255,0.45)', fontSize: '22px', marginTop: '28px' }}>
          Voix off · Musique originale · Mixage · Sound design
        </div>
