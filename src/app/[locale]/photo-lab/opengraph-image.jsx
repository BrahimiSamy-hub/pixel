...
export const alt = 'Shooting Photo & Studio Professionnel — Pixel Creative Agency Algérie'
    ...
    (
      ...
      >
        ...
        <div style={{ color: 'white', fontSize: '58px', fontWeight: '900', lineHeight: '1.1', maxWidth: '820px' }}>
          Shooting Photo & Studio Professionnel
        </div>
        <div style={{ color: 'rgba(255,255,255,0.45)', fontSize: '22px', marginTop: '28px' }}>
          Portraits · Produits · Événements · Tirages haute qualité
        </div>
