        ...
        >
          <div className='container min-h-screen'>
            <div className='text-center mb-12'>
              ...
              <h1 className='h1 mb-4 uppercase'>Photo Lab Professionnel — Portraits & Tirages</h1>
              <p className='text-xl text-gray-300 max-w-2xl mx-auto mb-8'>
                {t('photo_video_text')}
              </p>

              <Link
                href='/portfolio?category=PhotoShoot'
...
export default PhotoPricingClient
